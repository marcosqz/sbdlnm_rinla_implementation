...
# WARNING: WE LOAD THE OUTPUT FROM MODEL 3 EXECUTED WITH R-INLA AND THE 
...
load("input/result_inla/final_inla_model3_spatial_casecrossover.RData")
...
# FOR REGION 1 / ITERATION 1 (EQUIVALENT TO PANEL FIGURE 1 IN THE ORIGINAL SB-DLNM PAPER)
#--------------------------------------------------------------
...
### (EQUIVALENT TO FIGURE 2 IN THE ORIGINAL SB-DLNM PAPER)
#--------------------------------------------------------------
...
### (SAME AS FIGURE 4C IN THE ORIGINAL SB-DLNM PAPER)
#--------------------------------------------------------------
...
# Force RR are between the maximum and minimum values to avoid NAs
rr_plot[rr_plot < rr_min] <- rr_min
rr_plot[rr_plot > rr_max] <- rr_max
